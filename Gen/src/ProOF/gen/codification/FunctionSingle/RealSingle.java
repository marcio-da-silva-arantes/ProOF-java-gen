...
public abstract class RealSingle extends Approach{
    ...
    private final boolean has_stream;
    ...
    public void printer(StreamPrinter stream, double X[]) throws Exception {
        
    }
    public void results(LinkerResults link, double X[]) throws Exception {
        
    }
    public double evaluate(double X[], LinkedList<Result> stream) throws Exception{
        if(has_constraints){
            if(has_stream){
                return F(X, stream) + penality*G(X);
            }else{
     ...
     * @throws Exception 
     */
    protected double F(double X[], LinkedList<Result> stream) throws Exception{
        throw new UnsupportedOperationException("Not supported yet.");
    }
    /**
